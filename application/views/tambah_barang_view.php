				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										<li class="active"><a href="<?php echo site_url('kategori') ?>">Nama Barang</a></li>
									</ul>
					...
					<?php echo form_open_multipart('barang/create/'.$this->uri->segment(3)); ?>
								...
								<?php echo validation_errors(); ?>
									...
									<input type="text" class="form-control" id="namaBarang" name="namaBarang" placeholder="Input field">
								</div>
								<div class="form-group">
